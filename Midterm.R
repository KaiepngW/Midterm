...
strawb <- read_xlsx("C:/Users/kw482/Desktop/BU/615/strawberries-2022oct30-a.xlsx", col_names = T)
...
ggplot(strawb, aes(x = strawb$Year)) +geom_bar()

ggplot(strawb1, aes(x = Year, y = Value)) +
  geom_point() 
